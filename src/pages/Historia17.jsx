...
const Historia17 = () => {
    return <div className="bg-light">
        ...
        <div className="text-dark h1" style={{ marginBottom: "50px", marginTop:"30px" }}>Influencers</div>
            ...
            <div className="card col-sm-6 border-light" style={{ width: "800px", height: "700px" }}>
                ...
                />
                <div className="card-body">
                    <p className="card-text review1 fs-5" style={{ paddingLeft:"100px", paddingRight:"100px"}}>You basically just pick which games you play, which performance you want, and it'll suggest a rig for you. They make things much, much simpler and again for only $75 bucks? Okay!</p>
                    <div className="row">
                        <div className="col-sm-3">
