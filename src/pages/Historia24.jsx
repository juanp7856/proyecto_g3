                ...
                <div className="accordion-item" style={{ width: "50%" }}>
                  <h2 className="accordion-header" id="headingOne">
                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" >
                      <div className="col-4 fs-3" style={{ textAlign: "left" }}>
                        <img src= {PC} className="PC-Gamer" style={{ width: "110px", height:"120px"}} />
                      </div>
                  ...
                  <div id="collapseOne" className="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample" >
                    <div className="accordion-body bg-gradient" style={{ backgroundColor: "blue"}}>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src= {CPU} className="CPU" style= {{ width: "80px", height:"65px"}} /></div>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src= {GRAFICA} className="Grafica" style= {{ width: "65px", height:"65px"}}  /></div>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src= {RAM} className="Ram" style= {{ width: "65px", height:"65px"}} /></div>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src= {SSD} className="SSD" style= {{ width: "60px", height:"65px"}} /></div>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center" ><img src= {REFLIQUIDA} className="REFLIQUIDA" style= {{ width: "65px", height:"65px"}} /></div>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src= {VENTILADORES} className="PC-Gamer" style= {{ width: "50px", height:"65px"}} /></div>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src= {PC} className="PC" style= {{ width: "50px", height:"65px"}} /></div>
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center">NZXT H510</div>
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center">$99</div>
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src= {FUENTEPODER} className="Fuente" style= {{ width: "65px", height:"65px"}} /></div>
                            ...
                            <div className="col-4 fs-6 d-flex justify-content-center align-items-center"><img src={PLACAMADRE} className="Placa" style= {{ width: "50px", height:"65px"}} /></div>
